...
export default function Contactus() {
    return (
        <section id={"contactus"}
                 className={"w-full flex flex-col lg:flex-row lg:gap-10 justify-between md:px-20 px-2 py-10 lg:space-y-0 space-y-10 bg-[#EEEEEE]"}>
            <div className="flex flex-col md:items-start items-center space-y-5">
                ...
                <ul className="[&>li]:flex [&>li]:items-center [&>li]:space-x-3 [&>li>i]:text-lg space-y-4">
                    <li>
                        <i className="bi bi-envelope-fill text-primary"></i><p>tommy@gmail.com</p>
                    </li>
                    <li>
                        <i className="bi bi-telephone-fill text-primary"></i><p>809-241-2028</p>
                    </li>
                </ul>
            </div>
            
            <form>
                <div className={"bg-white shadow lg:w-[750px] py-10 md:px-10 px-5 rounded-lg"}>
