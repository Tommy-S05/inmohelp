            ...
            <section className="flex justify-center items-center gap-5 space-x-5 bg-white p-5">
                ...
                <div className="flex flex-col space-y-2">
                    <Link href={"/profile/edit-profile"}
                          className={'bg-primary py-1 rounded-full text-center text-white hover:bg-primary/80'}>
                        Editar Perfil
                    </Link>
                    <Link href={"#"}
                          className={'bg-primary py-1 px-4 rounded-full text-center text-white hover:bg-primary/80'}>
                        Cambiar Contraseña
                    </Link>
                    <button onClick={handleLogout}
                            className=" bg-primary py-1 rounded-full  text-white hover:bg-primary/80">
                        Salir
                    </button>
                </div>
            </section>
