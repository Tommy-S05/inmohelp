          ...
          <div className={"md:space-y-3"}>
            ...
            >
              <div className={"flex flex-col lg:space-y-1 md:space-y-0"}>
                <img
                  ...
                  alt="departamento"
                />
                <label className={"hidden md:flex md:flex-col"}>
                  Departamentos
                </label>
              </div>
              <div
                className={"grid md:grid-rows-2 lg:gap-2 md:gap-1 grid-cols-1"}
              >
            ...
            <div className={"flex flex-col  md:space-y-2  "}>
              <div className={"grid grid-cols-1 md:grid-cols-12 md:gap-5   "}>
                <div
                  className={
                    "col-span-4 flex flex-col lg:space-y-1 md:space-y-0"
                  }
                >
                  <img
                ...
                <div
                  className={
                    "col-span-8 flex flex-col lg:space-y-1 md:space-y-0"
                  }
                >
                  <img
              ...
              <div className={"grid grip-cols-1 md:grid-cols-12 md:gap-5"}>
                <div
                  className={
                    "md:col-span-7 flex flex-col lg:space-y-1 md:space-y-0"
                  }
                >
                  <img
                    className={"object-cover  md:w-full"}
                ...
                <div
                  className={
                    "col-span-5 flex flex-col lg:space-y-1 md:space-y-0"
                  }
                >
                  <img
                    className={"object-cover w-full"}
              ...
              <div className={"grid grip-cols-1 md:grid-cols-12 md:gap-5"}>
                <div
                  className={
                    "col-span-6 flex flex-col lg:space-y-1 md:space-y-0"
                  }
                >
                  <img
                    className={"object-cover w-full"}
