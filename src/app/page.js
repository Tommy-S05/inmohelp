  ...
  return (
    <main>
      ...
      <section id={"contactanos"} className={"relative"}>
        <div
          className={
            "absolute flex-col flex justify-center items-center h-full w-full "
          }
        >
          <h2 className={"font-bold text-5xl text-white"}>Contactanos</h2>
          <p className={"text-white my-7"}>Sabemos lo que necesitas</p>
        ...
        <div className={"bg-white w-full flex justify-center pb-14 pt-4 px-5"}>
          <img
            className={"h-[400px] w-[900px] lg:object-cover object-contain"}
